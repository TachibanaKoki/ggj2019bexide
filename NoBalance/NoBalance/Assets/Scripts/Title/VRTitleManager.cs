...
using Valve.VR;
public class VRTitleManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_touchText.text = "Trigger to Start";
    ...
    private void textupdate()
    {
        ...
        // タッチチェック
        if (Input.GetKeyDown(KeyCode.Space)||SteamVR_Input._default.inActions.InteractUI.GetStateDown(SteamVR_Input_Sources.Any))
        {
            Fader.FadeOut(1);
        }
